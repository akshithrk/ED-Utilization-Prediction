...
#
#RVAR predicted.fit -output -numeric -vector  #Metric Expression: RScript<_RScriptFile="J:\Ashley\ED Utilization Prediction\ED Utilization Low Resource.R", _InputNames="Age.Group, Problem.Count, CCC.Congenital, CCC.Hem.Imm, CCC.Malignancy, CCC.Metabolic, CCC.Renal, Public.or.Private.Metric, Holiday.Indicator, Cerebral.Palsy.DX,  Developmental.Disorders.Group.DX, Fractures.DX, Nausea.and.Vomiting.DX, Last.Primary.Care.Specialty.Seen, Prior.ED.Visit.Count.Orig, Gender, Major.Region,  Race.and.Ethnicity.Group", _WorkingDir="\\BI_ISD\BI_Share\Ashley\ED Utilization Prediction">(Age.Group, Problem.Count, CCC.Congenital, CCC.Hem.Imm, CCC.Malignancy, CCC.Metabolic, CCC.Renal, Public.or.Private.Metric, Holiday.Indicator, Cerebral.Palsy.DX,  Developmental.Disorders.Group.DX, Fractures.DX, Nausea.and.Vomiting.DX, Last.Primary.Care.Specialty.Seen, Prior.ED.Visit.Count.Orig, Gender, Major.Region,  Race.and.Ethnicity.Group)
#RVAR predicted.se.fit -output -numeric -vector  #Metric Expression: RScript<_RScriptFile="J:\Ashley\ED Utilization Prediction\ED Utilization Low Resource.R", _InputNames="Age.Group, Problem.Count, CCC.Congenital, CCC.Hem.Imm, CCC.Malignancy, CCC.Metabolic, CCC.Renal, Public.or.Private.Metric, Holiday.Indicator, Cerebral.Palsy.DX,  Developmental.Disorders.Group.DX, Fractures.DX, Nausea.and.Vomiting.DX, Last.Primary.Care.Specialty.Seen, Prior.ED.Visit.Count.Orig, Gender, Major.Region,  Race.and.Ethnicity.Group", _WorkingDir="\\BI_ISD\BI_Share\Ashley\ED Utilization Prediction">(Age.Group, Problem.Count, CCC.Congenital, CCC.Hem.Imm, CCC.Malignancy, CCC.Metabolic, CCC.Renal, Public.or.Private.Metric, Holiday.Indicator, Cerebral.Palsy.DX,  Developmental.Disorders.Group.DX, Fractures.DX, Nausea.and.Vomiting.DX, Last.Primary.Care.Specialty.Seen, Prior.ED.Visit.Count.Orig, Gender, Major.Region,  Race.and.Ethnicity.Group)
