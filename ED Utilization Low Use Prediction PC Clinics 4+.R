...
EDPredictorsLowusePC.2016.df <- select(EDLowusePC_cy2016.df, High.ED.Utilization.Indicator, Age.Group:Last.Primary.Care.Specialty.Seen,Prior.ED.Visit.Count.Orig, Gender, Major.Region, Race.and.Ethnicity.Group, ED.Shift)
...
EDPredictorsLowusePC.2017.df <- select(EDLowusePC_cy2017.df, High.ED.Utilization.Indicator, Age.Group:Last.Primary.Care.Specialty.Seen,Prior.ED.Visit.Count.Orig, Gender, Major.Region, Race.and.Ethnicity.Group, ED.Shift)
