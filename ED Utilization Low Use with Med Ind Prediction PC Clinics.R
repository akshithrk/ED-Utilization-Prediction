...
# 2017 ED Utilization
EDLowusePCMedInd_cy2016.df <- read.xlsx("Low Resource Use with Med Ind in 2016 Primary Care Clinic Well Child 2015-2016.xlsx")

# Validation data set
EDLowusePCMedInd_cy2017.df <- read.xlsx("Low Resource Use with Med Ind in 2017 Primary Care Clinic Well Child 2016-2017.xlsx")
